...
<div class="wrapper">
    ...
    <?php $articles = $anch->loadAllArticles(); ?>
    
<div class="title-acceuil">
    <a href="accueil.php" style="color: rgb(28, 101, 179); font-weight:bold;">Enchère en cours</a>
    <i class="fa fa-caret-right" style="margin: 0 8px;"></i>
    <a href="solded.php" style="color: slategrey;">Articles vendus</a>
</div>
